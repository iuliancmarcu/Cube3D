    ...
    public boolean cubeInFrustum(float x, float y, float z, float size) {
        for (int i = 0; i < 6; i++) {
            if (frustum[i][A] * x + frustum[i][B] * y + frustum[i][C] * z + frustum[i][D] > 0)
                continue;
            if (frustum[i][A] * (x + size) + frustum[i][B] * y + frustum[i][C] * z + frustum[i][D] > 0)
                continue;
            if (frustum[i][A] * x + frustum[i][B] * (y + size) + frustum[i][C] * z + frustum[i][D] > 0)
                continue;
            if (frustum[i][A] * (x + size) + frustum[i][B] * (y + size) + frustum[i][C] * z + frustum[i][D] > 0)
                continue;
            if (frustum[i][A] * x + frustum[i][B] * y + frustum[i][C] * (z + size) + frustum[i][D] > 0)
                continue;
            if (frustum[i][A] * (x + size) + frustum[i][B] * y + frustum[i][C] * (z + size) + frustum[i][D] > 0)
                continue;
            if (frustum[i][A] * x + frustum[i][B] * (y + size) + frustum[i][C] * (z + size) + frustum[i][D] > 0)
                continue;
